...
from src.nn_utils.nn import linear, bn_dense_layer, highway_network
...
class ModelHwResanBase(ModelTemplate):
    def __init__(self, token_emb_mat, glove_emb_mat, tds, cds, tl, scope):
        super(ModelHwResanBase, self).__init__(token_emb_mat, glove_emb_mat, tds, cds, tl, scope)
