...
from resan.utils.general import flatten, reconstruct, exp_mask, add_reg_without_bias,\
    exp_mask_for_high_rank, mask_for_high_rank, add_var_reg
from resan.utils.basic import selu
...
def highway_network_old(arg, num_layers, bias, bias_start=0.0, scope=None, wd=0.0, input_keep_prob=1.0, is_train=None):
